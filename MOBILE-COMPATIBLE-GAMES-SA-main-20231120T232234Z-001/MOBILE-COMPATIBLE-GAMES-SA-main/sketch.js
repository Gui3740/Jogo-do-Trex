...
function setup() {
  createCanvas(windowWidth, windowHeight);//add
  
  sun = createSprite(width-50, 100, 10, 10);//add
  sun.addAnimation("sun", sunAnimation);
  sun.scale = 0.1
  
  trex = createSprite(50, height-70, 20, 50); //add
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(touches.lenght>0 || (keyDown("SPACE")) && trex.y  >= height-120) { //add
      jumpSound.play( )
      trex.velocityY = -10;
       //add
    }
